...
class CityWeather extends StatefulWidget {
  ...
  const CityWeather({super.key, required this.weather});
...
class _CityWeatherState extends State<CityWeather> {
  ...
  fetchWeather() async {
    ...
    try {
      ...
      final forecasts = await _WeatherService.getFiveDayForecast(widget.weather.cityName);
      print(widget.weather.cityName);
      List<Location> locations = await locationFromAddress(widget.weather.cityName);
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(height: 5),
                                            Image.asset(
                                              widget.weather.mainCondition.toLowerCase() == 'snow' ? 'assets/snow.png' :'assets/shower.png',
                                              fit: BoxFit.contain,
                                              width: 35,
                                            ),
                                            const SizedBox(height: 5),
                                            Text(
                                              (_forecasts![0].pop == null || (_forecasts![0].pop! * 100).round() == 0)
                                                ? widget.weather.mainCondition.toLowerCase() == 'snow' ? "No snow" : "No rain"
